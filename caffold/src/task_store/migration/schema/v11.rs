...
pub(in crate::task_store::migration) const NOTE_DIRECTORIES_TABLE: &str = "note_directories";
pub(in crate::task_store::migration) const NOTES_TABLE: &str = "notes";
...
const MANAGED_SECTION_COLUMN_DEFINITIONS: &[&str] = &[
...
pub(in crate::task_store::migration) const NOTE_DIRECTORY_COLUMN_DEFINITIONS: &[&str] = &[
...
pub(in crate::task_store::migration) const NOTE_COLUMN_DEFINITIONS: &[&str] = &[
    ...
    S: GStore + GStoreMut + Planner,
{
    ...
    validate_table(
        glue,
        NOTE_DIRECTORIES_TABLE,
        NOTE_DIRECTORY_COLUMN_DEFINITIONS,
    )?;
    validate_table(glue, NOTES_TABLE, NOTE_COLUMN_DEFINITIONS)?;
