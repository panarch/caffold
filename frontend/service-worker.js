...
const APP_SHELL_ASSETS = [
  ...
  "/assets/pages/(task-workspace)/keyboard-navigation/components/hud.css",
  "/assets/pages/(task-workspace)/keyboard-navigation/components/hud.js",
  "/assets/pages/(task-workspace)/keyboard-navigation/components/selector.css",
  "/assets/pages/(task-workspace)/keyboard-navigation/components/selector.js",
  "/assets/pages/(task-workspace)/components/keyboard-navigation-presentation.css",
  "/assets/pages/(task-workspace)/components/keyboard-navigation-presentation.js",
  "/assets/pages/(task-workspace)/action-hints.js",
  "/assets/pages/(task-workspace)/action-hints/control.js",
  "/assets/pages/(task-workspace)/action-hints/model.js",
  "/assets/pages/(task-workspace)/action-hints/components/dialog.css",
  "/assets/pages/(task-workspace)/action-hints/components/dialog.js",
