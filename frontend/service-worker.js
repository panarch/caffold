...
const APP_SHELL_ASSETS = [
  ...
  "/assets/pages/(task-workspace)/tasks/components/detail/conversation/components/command.css",
  "/assets/pages/(task-workspace)/tasks/components/detail/conversation/components/command.js",
  "/assets/pages/(task-workspace)/tasks/components/detail/conversation/components/command/model.js",
