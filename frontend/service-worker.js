...
const APP_SHELL_ASSETS = [
  ...
  "/assets/pages/(task-workspace)/tasks/components/detail/(github)/(issues)/components/task-start-dialog.css",
  "/assets/pages/(task-workspace)/tasks/components/detail/(github)/(issues)/components/task-start-dialog.js",
