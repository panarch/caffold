const CACHE_NAME = "caffold-shell-v177";
...
const APP_SHELL_ASSETS = [
  ...
  "/assets/pages/components/about-dialog.css",
  "/assets/pages/components/about-dialog.js",
  ...
  "/assets/pages/(codex)/tasks/controls.css",
  ...
  "/assets/pages/(codex)/tasks/components/image-preview-dialog.css",
  "/assets/pages/(codex)/tasks/components/image-preview-dialog.js",
  "/assets/pages/(codex)/tasks/components/voice-recorder.js",
  "/assets/pages/(codex)/tasks/components/voice-worklet.js",
  "/assets/pages/(codex)/tasks/components/detail.css",
  "/assets/pages/(codex)/tasks/components/detail.js",
  "/assets/pages/(codex)/tasks/components/detail/stream.js",
  "/assets/pages/(codex)/tasks/components/detail/summary.css",
  "/assets/pages/(codex)/tasks/components/detail/summary.js",
  ...
  "/assets/pages/(codex)/tasks/components/task-status.js",
